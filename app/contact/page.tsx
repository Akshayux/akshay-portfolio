...
export default function ContactPage(){return <main id="top" className="contact-page">
  ...
  <section className="contact-hero shell">
    ...
    <div className="contact-content reveal">
      ...
      <div className="contact-buttons"><Button href={`mailto:${profile.email}?subject=Design%20opportunity`}>Email me <Arrow/></Button><Button href="/resume" secondary>View résumé <Arrow/></Button></div>
    </div>
  </section>
