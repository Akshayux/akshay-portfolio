...
export default function ScotCarePage(){return <main id="top" className="case-page scotcare-case">
  ...
  <section className="case-hero-media scotcare-hero-media reveal" data-parallax><img src="/optimized/mobile-mockup-cover.jpg" alt="ScotCare connected care-navigation experience across five mobile screens"/></section>
  ...
  <section className="case-section case-wide scotcare-gallery" id="experience"><div className="case-section-heading reveal"><Kicker>Final experience</Kicker><h2>A connected journey from concern to follow-up.</h2><p>Each stage keeps the route, reason and next action visible while care moves between digital guidance and people.</p></div><ol className="journey-flow journey-flow-care reveal" aria-label="Connected ScotCare service journey"><li><span>01</span><strong>Concern</strong></li><li><span>02</span><strong>Triage</strong></li><li><span>03</span><strong>Care route</strong></li><li><span>04</span><strong>Appointment</strong></li><li><span>05</span><strong>Preparation</strong></li><li><span>06</span><strong>Waiting</strong></li><li><span>07</span><strong>Follow-up</strong></li></ol><div className="report-grid"><figure className="reveal"><img src="/optimized/home.jpg" loading="lazy" decoding="async" alt="ScotCare welcome and home experience"/><figcaption>01 · A clear starting point</figcaption></figure><figure className="reveal"><img src="/optimized/recommendation.jpg" loading="lazy" decoding="async" alt="ScotCare explained care recommendation"/><figcaption>02 · A route, reason and next action</figcaption></figure><figure className="reveal"><img src="/optimized/preparation.jpg" loading="lazy" decoding="async" alt="ScotCare appointment preparation experience"/><figcaption>03 · Preparing for human care</figcaption></figure><figure className="reveal"><img src="/optimized/monitoring.jpg" loading="lazy" decoding="async" alt="ScotCare symptom monitoring and follow-up"/><figcaption>04 · Safety-netting after the decision</figcaption></figure></div></section>

  <section className="case-section case-wide evidence-band reveal"><div><Kicker>Responsive behaviour</Kicker><h2>The priority stays stable as the layout expands.</h2><p>Mobile remained the primary format. Tablet and desktop adapt the same content hierarchy through flexible containers and reusable components, while urgent and primary actions remain prominent.</p></div><figure><img src="/optimized/responsive.jpg" loading="lazy" decoding="async" alt="ScotCare mobile tablet and desktop layouts"/><figcaption>Responsive concept · mobile, tablet and desktop</figcaption></figure></section>

  <section className="case-section case-narrow"><div className="case-split"><div className="reveal"><Kicker>Iteration</Kicker><h2>Safety changed the visual hierarchy.</h2></div><div className="reveal"><p>An earlier home screen hid urgent options inside an expandable card. The revised design keeps 999, NHS 24 and A&amp;E guidance directly visible, because reducing density was not worth adding friction before safety-critical information.</p><img className="inline-report-image" src="/optimized/refinement.jpg" loading="lazy" decoding="async" alt="ScotCare emergency support design refinement"/></div></div></section>
