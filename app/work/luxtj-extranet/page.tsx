...
export default function ExtranetPage(){return <main id="top" className="case-page extranet-case">
  ...
  <section className="case-hero-media extranet-hero-media reveal" data-parallax><img src="/figma/case-1.png" alt="LUXTJ partner extranet listing dashboard"/></section>
  ...
  <section className="case-section case-wide evidence-band reveal"><div><Kicker>Selected interface</Kicker><h2>Listings combine rich content with clear operational control.</h2><p>Property imagery and customer-facing details remain recognisable, while administrative actions, settings and states are organised around the job the partner needs to complete.</p></div><figure><img src="/figma/case-15.png" alt="LUXTJ extranet listing management interface"/><figcaption>Partner listing management · desktop</figcaption></figure></section>
