...
export default function Home(){return <PageFrame>
  <section className="hero shell">
    <div className="hero-copy">
      ...
      <div className="hero-intro"><p>I&apos;m Akshay. I turn complicated workflows, systems and ideas into digital products people understand and enjoy using.</p><div><Link className="text-link" href="/work">See my work <Arrow/></Link><Link className="text-link quiet-link" href="/resume">View résumé <Arrow/></Link></div></div>
    </div>
